...
const string windowNameResult = "Resutlt";
...
int main(int argc, char* argv[]){
  ...
  createTrackbar(trackbarNameBrightness, windowNameResult, &trackbarBrightness, TRACKBAR_MAX, onChange);
  const string trackbarNameContrast = "Contrast";
  createTrackbar(trackbarNameContrast, windowNameResult, &trackbarContrast, TRACKBAR_MAX, onChange);
